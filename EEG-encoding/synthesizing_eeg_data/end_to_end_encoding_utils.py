def load_images(args, idx_val):
	...
	img_dirs = os.path.join('/mnt/repo0/ldy/4090_THINGS', 'images_set', 'training_images')
	image_list = []
	...
	img_dirs = os.path.join('/mnt/repo0/ldy/4090_THINGS', 'images_set', 'test_images')
	image_list = []
	for root, dirs, files in os.walk(img_dirs):
		for file in files:
			if file.endswith(".jpg"):
...
def load_eeg_data(args, idx_val):
	...
	training_file = 'preprocessed_eeg_test.npy'
	...
	### Output ###
	return y_train, y_val, y_test, selected_channels, times

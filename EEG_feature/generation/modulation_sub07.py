...
def main_experiment_loop(seed, save_path):
    ...
    model_path = '/mnt/repo0/kyw/close-loop/sub_encoder_alexnet/sub-07/model_state_dict.pt'
    ...
    target_eeg_path = '/mnt/repo0/kyw/close-loop/sub_encoder_alexnet_test/sub-07/00183_tick_183.npy'
...
if __name__ == "__main__":
    ...
    for i in range(1, num_run + 1):
        base_save_path = f'/mnt/repo0/kyw/close-loop/10_2/exp_sub_07/loop_random_{i}'
